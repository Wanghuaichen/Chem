...
function LateUpdate () {
	...
	{
		var section = MyTronTrailSection ();
	...
	var previousSection : MyTronTrailSection = sections[0];
	var currentSection : MyTronTrailSection = sections[0];
